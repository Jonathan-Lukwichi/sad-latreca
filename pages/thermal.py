...
def update_thermal(store):
    ...
    try:
        ...
        return (None, {}, {}, None,
                alert("danger", "Erreur", f"{e}", "alert"), None)

    T_max = resultat['KPIs']['T_max_C']
    marge = resultat['KPIs']['marge_thermique_C']
    sec = resultat['securite']['C2_thermique']
    delta_T_max = max(resultat['delta_T'])
